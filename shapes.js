...
draw_track = (x,y,z,pillar) => {
  ...
  if(pillar){
    C.plane({w:10,h:600,x:x,y:y,z:z-300.2,b:"#555",rx:-90});
  }
}
...
draw_hills = () => {
  ...
  C.plane({w:600,h:1200,x:650,z:-.5,css:"hill"});
  C.plane({w:600,h:1200,x:-350,z:-.5,ry:75,o:"left",css:"hill2"});
  C.plane({w:600,h:1200,x:350,z:-.5,ry:-75,o:"right",css:"hill2"});
  C.plane({w:400,h:600,x:-500,z:-300.5,rx:-90,sk:"15deg",css:"hill3 left"});
  C.plane({w:400,h:600,x:500,z:-300.5,rx:-90,sk:"-15deg",css:"hill3 right"});
